var chai 	= require('chai'),
    assert  = chai.assert,
    lib = require('../lib/helper-isodate.js');
...
describe('ISO datetime helper -', function(){
    ...
    describe('isDuration', function(){
        it('PY1M11 - true', function(){
        	assert.isTrue(lib.isDuration('PY1M11'));
        });
        it('PW42 - true', function(){
        	assert.isTrue(lib.isDuration('PW42'));
        });
        ...
        it('2007 - false', function(){
        	assert.isFalse(lib.isDuration('2007'));
        });
        it('2007-05-01T21:30:00.0150 - false', function(){
        	assert.isFalse(lib.isDuration('2007-05-01T21:30:00.0150'));
        });
    })
...
/*    describe('isFullDate', function(){
    ...
    describe('parseAmPmTime', function(){
        it('21:30', function(){
        	assert.equal(lib.parseAmPmTime('21:30'), '21:30');
        });
        it('21:30:45', function(){
        	assert.equal(lib.parseAmPmTime('21:30:45'), '21:30:45');
        });
        it('21:30:45.0123', function(){
        	assert.equal(lib.parseAmPmTime('21:30:45.0123'), '21:30:45.0123');
        });
        it('9:30', function(){
        	assert.equal(lib.parseAmPmTime('9:30'), '09:30');
        });
        it('9:30pm', function(){
        	assert.equal(lib.parseAmPmTime('9:30pm'), '21:30');
        });
        it('9:30am', function(){
        	assert.equal(lib.parseAmPmTime('9:30am'), '09:30');
        });
        it('9:30A.M.', function(){
        	assert.equal(lib.parseAmPmTime('9:30A.M.'), '09:30');
        });
        it('9:30 pm', function(){
        	assert.equal(lib.parseAmPmTime('9:30 pm'), '21:30');
        });
    })
