...
describe('Broken into properties (h-recipe parsing test)', function() {
   ...
   it("found.items[0].properties['ingredient'][0].value", function(){
      assert.equal(found.items[0].properties["ingredient"][0].value, "1 egg");
   })

   it("found.items[0].properties['ingredient'][1].value", function(){
      assert.equal(found.items[0].properties["ingredient"][1].value, "75g plain flour");
   })

   it("found.items[0].properties['ingredient'][2].value", function(){
      assert.equal(found.items[0].properties["ingredient"][2].value, "70ml milk");
   })

   it("found.items[0].properties['ingredient'][3].value", function(){
      assert.equal(found.items[0].properties["ingredient"][3].value, "60ml water");
   })

   it("found.items[0].properties['ingredient'][4].value", function(){
      assert.equal(found.items[0].properties["ingredient"][4].value, "Pinch of salt");
   })
