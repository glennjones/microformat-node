...
describe('Competency - Experimental property (h-resume parsing test)', function() {
   var htmlFragment = "\n<div class=\"h-resume\">\n    <p>\n        <span class=\"p-name\">Tim Berners-Lee</span>, \n        <span class=\"p-summary\">invented the World Wide Web</span>.\n    </p>\n    Experience and skills:     \n    <ul>\n        <li class=\"p-skill h-competency\">\n            <span class=\"p-name\">information systems</span> (\n                <span class=\"p-rate\">5</span>/5  –  \n                <time class=\"dt-duration\" datetime=\"PY37\">37 years</time>\n        )</li>\n        <li class=\"p-skill h-competency\">\n            <span class=\"p-name\">advocacy</span> (\n                <span class=\"p-rate\">4</span>/5  – \n                <time class=\"dt-duration\" datetime=\"PY22\">22 years</time>\n        )</li>\n        <li class=\"p-skill h-competency\">\n            <span class=\"p-name\">leadership</span> (\n                <span class=\"p-rate\">5</span>/5  – \n                <time class=\"dt-duration\" datetime=\"PY22\">22 years</time>\n        )</li>\n    <ul>   \n</ul></ul></div>\n"
   var found = helper.parseHTML(htmlFragment,'http://example.com/')
   var expected = {"items":[{"type":["h-resume"],"properties":{"name":["Tim Berners-Lee"],"summary":["invented the World Wide Web"],"skill":[{"value":"information systems ( 5/5 - 37 years )","type":["h-competency"],"properties":{"name":["information systems"],"rate":["5"],"duration":["PY37"]}},{"value":"advocacy ( 5/5 - 22 years )","type":["h-competency"],"properties":{"name":["advocacy"],"rate":["5"],"duration":["PY22"]}},{"value":"advocacy ( 5/5 - 22 years )","type":["h-competency"],"properties":{"name":["leadership"],"rate":["5"],"duration":["PY22"]}}]}},{"type":["h-competency"],"properties":{"name":["information systems"],"rate":["5"],"duration":["PY37"]}},{"type":["h-competency"],"properties":{"name":["advocacy"],"rate":["5"],"duration":["PY22"]}},{"type":["h-competency"],"properties":{"name":["leadership"],"rate":["5"],"duration":["PY22"]}}]}
