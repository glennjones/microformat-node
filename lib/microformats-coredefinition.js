                ...
                subproperties: {
                    "interval": {
                        ...
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "interval");
                        }
                    },
                    "freq": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "freq");
                        }
                    },
                    "bysecond": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "bysecond");
                        }
                    },
                    "byminute": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "byminute");
                        }
                    },
                    "byhour": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "byhour");
                        }
                    },
                    "bymonthday": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "bymonthday");
                        }
                    },
                    "byyearday": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "byyearday");
                        }
                    },
                    "byweekno": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "byweekno");
                        }
                    },
                    "bymonth": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "bymonth");
                        }
                    },
                    "byday": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "byday");
                        }
                    },
                    "until": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "until");
                        }
                    },
                    "count": {
                        virtual: true,
                        /* This will only be called in the virtual case */
                        virtualGetter: function (context, mfnode, node) {
                            return context.hCalendar.properties.rrule.retrieve(node, "count");
                        }
                    }
                },
                retrieve: function (node, property) {
                    //var value = ufShiv.internal.textGetter(mfnode);
                    var value = ufShiv.internal.defaultGetter(node);
                    var rrule;
                    rrule = value.split(';');
