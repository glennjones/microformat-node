          ...
          getTextFromRepo(url, function(err, html){
            if(html){
                var parts = url.split('/'),
                  ...
                  out1 = '/*\rMocha integration test from: ' + fileName + '\rThe test was built on ' + date + '\r*/\r\r';
                  out2 = '/*\rMocha integration test from: ' + fileName + '\rThe test was built on ' + date + '\r*/\r\r';


                out1 += "var chai = require('chai'),\r   assert = chai.assert,\r   helper = require('../test/helper.js');\r\r\r" 
                out2 += "var assert = chai.assert;\r\r\r" 
