    ...
    properties: {
        ...
        "nickname": {
            ...
            virtualGetter: function (context, mfnode) {
                ...
                var given_name;
                var family_name;
                if ((fn && fn.length) && (!orgs || (orgs.length) > 1 || (fn != orgs[0]["organization-name"]))) {
                    var fns = fn[0].split(" ");
                    if (fns.length === 1) {
                        return [fns[0]];
                    }
...
// -----------------------------------------
 ...
 var hcard2 = {
    ...
    properties: {
        ...
        "p-post-office-box": {plural: true},
        "p-street-address": {plural: true},
        "p-extended-address": {plural: true},
        "p-locality": {plural: true},
        "p-region": {plural: true},
        "p-postal-code": {plural: true},
        "p-latitude": {plural: true},
        "p-longitude": {plural: true},
        "p-altitude": {plural: true},
        "u-key": {plural: true},
        "p-label": {plural: true},
        "u-logo": {
            plural: true,
        ...
        "p-mailer": {plural: true},
        "p-honorific-prefix": {plural: true},
        "p-given-name": {plural: true},
        "p-additional-name": {plural: true},
        "p-family-name": {plural: true},
        "p-honorific-suffix": {plural: true},
        "p-nickname": {plural: true,},
        "p-note": {
            plural: true,
            datatype: "HTML"
        },
        "p-org": {plural: true},                        
        "p-organization-name": {plural: true},
        "p-organization-unit": {plural: true},
        "u-photo": {
            plural: true,
            datatype: "anyURI"
        },
        ...
        "p-role": {plural: true},
        "p-sequence": {plural: true},
        "p-sort-string": {plural: true},
        "p-sound": {plural: true},
        "p-title": {plural: true},
        "p-tel": {plural: true},
        "p-tz": {plural: true},
    ...
    postProcess : function(context, node, data){
        if(context.hasProperties(data) === false) {
            if(node.tagName === 'IMG'){
                // If its a hyperlink get name and photo
                addImageData(node)
            } else if(node.tagName === 'A') {
                if(context.containsTag(node,'IMG')){
                    // If node conatins a image
                    addImageData(context.containsTag(node,'IMG'));
                }else{
                    // If its a hyperlink get name and url
                    addLinkData(node)
                }
                if(node.getAttribute('href'))
                    data.url = [node.getAttribute('href')];
            }else{
                // Any other node just take the inner text
                addLinkData(node)
            }
            
        }

        function addImageData(aNode){
            if(aNode.getAttribute('alt'))
                data.name = [aNode.getAttribute('alt')];
            if(aNode.getAttribute('src'))
                data.photo = [aNode.getAttribute('src')];
        }

        function addLinkData(aNode){
            if(context.trim(context.getTextContent(aNode)) !== '')
                    data.name = [context.trim(context.getTextContent(aNode))];
        }
    }
};
 ...
 var hevent = {
    ...
    properties: {
        ...
        "dt-end": {
            ...
            /* If we got here, we have a dtend time without date */
            virtualGetter: function (context, mfnode) {
                var dtends = context.getElementsByClassName(mfnode, "dt-end");
                if (dtends.length === 0) {
                    return undefined;
                }
                var dtend = context.dateTimeGetter(dtends[0], mfnode, true);
                var dtstarts = context.getElementsByClassName(mfnode, "dt-start");
                if (dtstarts.length > 0) {
                    var dtstart = context.dateTimeGetter(dtstarts[0], mfnode);
                    if (dtstart.match("T")) {
                        return context.normalizeISO8601(dtstart.split("T")[0] + "T" + dtend);
...
var hresume2 = {
  ...
  properties: {
    ...
    "p-education" : {
        ...
        datatype: "microformat",
        microformat: "hCalendar",
        subproperties: deepMerge(hcard2.properties, hevent.properties)
    },
    "p-experience" : {
        datatype: "microformat",
        microformat: "hCalendar",
 ...
 var hentry2 = {
  ...
  properties: {
    "p-name" : {plural: true},
    "e-content" : {plural: true},
    "p-summary" : {plural: true},
    "dt-published" : {
      datatype: "dateTime"
    },
    "dt-updated" : {
      ...
      datatype: "dateTime",
      virtualGetter: function(context, mfnode) {
          return context.getMicroformatProperty(mfnode, "h-entry", "dt-published");
      }
    },
    "p-author": {plural: true},
    "p-category": {plural: true},
    "u-uid": {
        plural: true,
        datatype: "anyURI"
...
var htestSuite = {
    className: "h-x-test-suite",
    properties: {
        "p-name": {plural: true},
        "p-description": {plural: true},
        "p-author": {
            datatype: "microformat",
            microformat: "h-card",
            plural: true
...
var htestFixture = {
    className: "h-x-test-fixture",
    properties: {
        "name":{plural: true},
        "p-x-format":{plural: true},

        "e-x-microformat" :{plural: true},
/*               "e-x-microformat": {
            plural: true,
            virtual: true,
            virtualGetter: function (context, mfnode) {
                return mfnode.innerHTML;
            }
        },*/

        "p-x-output" :{plural: true},
        "p-x-assert": {
            datatype: "microformat",
            microformat: "h-x-assert",
            plural: true
         }
    }
};
...
var hassert = {
    className: "h-x-assert",
    properties: {
        "p-x-test":{plural: true},
        "p-x-result":{plural: true},
        "p-summary":{plural: true}
    }
};
...
exports.hresume2 = hresume2;
exports.hentry2 = hentry2;
exports.hadr = hadr;
exports.htag = htag;
exports.hgeo = hgeo;
exports.hcard2 = hcard2;
exports.hevent = hevent;
exports.htestSuite = htestSuite;
exports.htestFixture = htestFixture;
exports.hassert = hassert;
